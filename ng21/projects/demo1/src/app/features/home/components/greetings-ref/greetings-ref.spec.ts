...
describe('GreetingsRef with local references', () => {
  let component: GreetingsRef;
  let fixture: ComponentFixture<GreetingsRef>;
  let debugElement: DebugElement;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [GreetingsRef],
    }).compileComponents();

    fixture = TestBed.createComponent(GreetingsRef);
